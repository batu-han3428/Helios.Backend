...
(function ($) {
    ...
    function toHtml(target, rows, footer, caption, fields) {
        ...
        var dg = $(target);
        var data = ['<table rull="all" style="border-collapse:collapse">'];
        ...
        for (var i = 0; i < fields.length; i++) {
            ...
            tdStyle += ';text-align:center;background-color:#add8e6;white-space:nowrap;';
        ...
        $.map(rows, function (row) {
            ...
            for (var i = 0; i < fields.length; i++) {
                ...
                var tdStyle = tdStyle0 + ';width:' + w + 'px;';
                data.push(
